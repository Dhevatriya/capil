    ...
    <section class="wrapper">
      ...
      <?php } ?>
       ...
       <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="<?=site_url('PendafKKC/datapendudukeditproses');?>">
        <div>
              <input id="idKeluarga_FK" name="idKeluarga_FK" type="hidden" value="<?php echo $get_datapenduduk['idKeluarga_FK']; ?>"/>
              ...
              <section class="panel">
                ...
                <?php $dataE=$this->session->userdata('petEdit'); ?>
                  ...
                  <div class="form-group ">
                      ...
                      <div class="col-lg-8">
                          <select class="form-control m-bot15" id= "nama_pendidikan" name="nama_pendidikan" required>
                          <?php
                            foreach ($pendkkn as $data) { ?>
                            <option <?php if ($data->nama_pendidikan == $get_datapenduduk['nama_pendidikan']) {echo "selected";} ?> value="<?php echo $data->id_pendidikan ?>" ><?php echo $data->nama_pendidikan ?></option>
                          <?php } ?>
                        </select>
                        </div>
                  </div>
                  ...
                  <div class="form-group ">
                      ...
                      <div class="col-lg-8">
                        <select class="form-control m-bot15" id= "nama_status_hub_dalam_keluarga" name="nama_status_hub_dalam_keluarga" required>
                          <?php
                            // foreach ($get_datapenduduk['nama_jenispekerjaan'] as $value);
                            foreach ($stats as $data) {
                          ?>
                            <option <?php if ($data->nama_status_hub_dalam_keluarga == $get_datapenduduk['nama_status_hub_dalam_keluarga']) {echo "selected";} ?> value="<?php echo $data->id_status_hub_dalam_keluarga ?>" ><?php echo $data->nama_status_hub_dalam_keluarga ?></option>
                          <?php
                          } ?>
                        </select>
                        </div>
                  ...
                  <div class="form-group ">
                      <label for="cname" class="control-label col-lg-3" style="text-align: left; padding-left: 7%;">Nomor Paspor</label>
                      <div class="col-lg-8">
                           <input class="form-control " id="no_paspor" name="no_paspor" type="text" value="<?php echo $get_datapenduduk['no_paspor']; ?>"/>
                      </div>
                  </div>
                  <div class="form-group ">
                      <label for="cname" class="control-label col-lg-3" style="text-align: left; padding-left: 7%;">Nomor Kitas/Kitap</label>
                      <div class="col-lg-8">
                           <input class="form-control " id="no_kitas_kitap" name="no_kitas_kitap" type="text"  value="<?php echo $get_datapenduduk['no_kitas_kitap']; ?>"/>
                      </div>
                  </div>
                  <div class="form-group ">
                  ...
                  <center><div class="form-group ">
                      <div class="col-lg-12">
                          ...
                          <a href="<?php echo site_url('PendafKKC/caridatakk/'.$get_datapenduduk['idKeluarga_FK']) ?>"><button class="btn btn-default" name="batal" type="button">Batal</button></a>
                      </div>
                  </center></div>
              </form>
            </center>
