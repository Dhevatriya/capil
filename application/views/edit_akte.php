...
<body>
  ...
  ?>
    <section class="wrapper">
      <div class="row">
        <div class="col-lg-12">
            <h3 class="page-header">Form Edit Data Akte</h3>
        </div>
      </div>
                  ...
                  <center>
                    <div class="form-group ">
                      <div class="col-lg-12">
                          ...
                          <a href="<?php echo site_url('PendafAkteC/inputpendafakte/'.$datapendaftaran['id_pendaftaran']) ?>"><button class="btn btn-default" name="batal" type="button">Batal</button></a>
                      </div>
                  </center>
                </div>
              </form>
