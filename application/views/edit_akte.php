  ...
  ?>
    <section class="wrapper">
      ...
      <?php } ?>
       ...
       <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="<?=site_url('PendafAkteC/datapendudukeditproses');?>">
              <section class="panel">
                  ...
                  <center>
                    <div class="form-group ">
                      <div class="col-lg-12">
                          ...
                          <a href="<?php echo site_url('PendafAkteC/caridata/'.$get_datapenduduk['nik']) ?>"><button class="btn btn-default" name="batal" type="button">Batal</button></a>
                      </div>
                  </center>
                </div>
              </form>
