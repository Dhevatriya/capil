            ...
            <div class="top-nav notification-row">  
                <ul class="nav pull-right top-menu">
                     <li class="<?php echo menuaktif('kk',$aktif); ?>"> 
                        <a class="" href="<?php echo site_url('PendafKKC') ?>" class=""> <span>Pendaftaran KK</span> </a>
                    </li>
                    <li > 
                        <a class="" href="<?php echo site_url('PendafKKC/laporanpendaftarankk') ?>" class=""> <span>Laporan Pendaftaran KK</span> </a>
                    </li>
