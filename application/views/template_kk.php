          ...
          <li class="dropdown user user-menu">
            <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>PendafKKC/logout" onclick="return confirm('Apakah anda yakin ingin keluar?');"><i class="icon_key_alt"></i> Keluar</a>
                            </li>
                        </ul>
                    </li>
            <!-- </ul> -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="<?php echo menuaktif('berandakk',$aktif); ?>"> 
          <a class="" href="<?php echo base_url() ?>PendafKKC" class=""> 
          <i class="fa fa-dashboard" ></i> 
          <span>Beranda</span> 
          </a>
        </li>  
        <li class="<?php echo menuaktif('kk',$aktif); ?>"> 
          <a class="" href="<?php echo base_url() ?>PendafKKC/inputpendaftaran" >
          <i class="fa fa-edit" ></i> 
          <span>Pendaftaran KK</span> 
          </a>
        </li>
        <li class="<?php echo menuaktif('syaratkk',$aktif); ?>"> 
          <a class="" href="<?php echo base_url() ?>PendafKKC/syaratpendafkk">
          <i class="fa fa-file-image-o" ></i> 
          <span>Unggah Syarat KK</span> 
          </a>
        </li>
        <li class="<?php echo menuaktif('riwayatkk',$aktif); ?>"> 
          <a class="" href="<?php echo base_url() ?>PendafKKC/riwayatpendafkk">
          <i class="fa fa-book" ></i> 
          <span>Riwayat Pendaftaran KK</span> 
          </a>
        </li>
        <li class="<?php echo menuaktif('laporankk',$aktif); ?>"> 
          <a class="" href="<?php echo base_url() ?>PendafKKC/laporanpendaftarankk">
          <i class="fa fa-table" ></i> 
          <span>Laporan Pendaftaran KK</span> 
          </a>
        </li>
    </section>
    <!-- /.sidebar -->
