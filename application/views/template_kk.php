                ...
                <ul class="nav pull-right top-menu">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="<?php echo site_url('PendafKKC/logout'); ?>" onclick="return confirm('Apakah anda yakin ingin keluar?');"><i class="icon_key_alt"></i> Log Out</a>
                            </li>
                        </ul>
                    </li>
                </ul>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">  
                   <li class="<?php echo menuaktif('kk',$aktif); ?>"> 
                        <a class="" href="<?php echo site_url('PendafKKC') ?>" ><i class="icon_document_alt" ></i><span>Pendaftaran KK</span> </a>
                    </li>
                    <li class="<?php echo menuaktif('laporan',$aktif); ?>"> 
                        <a class="" href="<?php echo site_url('PendafKKC/laporanpendaftarankk') ?>"><i class="icon_document_alt" ></i><span>Laporan Pendaf KK</span> </a>
                    </li> 
