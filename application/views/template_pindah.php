          ...
          <li class="dropdown user user-menu">
            <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended">
                            ...
                            <li>
                                <a href="<?php echo base_url(); ?>PendafPindahC/logout" onclick="return confirm('Apakah anda yakin ingin keluar?');"><i class="icon_key_alt"></i> Keluar</a>
                            </li>
                        </ul>
                    </li>
            <!-- </ul> -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      <ul class="sidebar-menu" data-widget="tree">
        <li class="<?php echo menuaktif('berandapindah',$aktif); ?>"> 
          <a class="" href="<?php echo base_url() ?>PendafPindahC" class=""> 
          <i class="fa fa-dashboard" ></i> 
          <span>Beranda</span> 
          </a>
        </li>  
        <li class="<?php echo menuaktif('pindah',$aktif); ?>"> 
          <a class="" href="<?php echo base_url() ?>PendafPindahC/inputpendaftaran" >
          <i class="fa fa-edit" ></i> 
          <span>Pendaftaran Pindah</span> 
          </a>
        </li>
        <li class="<?php echo menuaktif('pindahd',$aktif); ?>"> 
          <a class="" href="<?php echo base_url() ?>PendafPindahC/inputpendaftaranpd" >
          <i class="fa  fa-pencil" ></i> 
          <span>Pendaftaran Pindah Datang</span> 
          </a>
        </li>
        <li class="<?php echo menuaktif('syaratpindah',$aktif); ?>"> 
          <a class="" href="<?php echo base_url() ?>PendafPindahC/syaratpendafpindah">
          <i class="fa fa-file-image-o" ></i> 
          <span>Unggah Syarat Pindah</span> 
          </a>
        </li>
        <li class="<?php echo menuaktif('riwayatpindah',$aktif); ?>"> 
          <a class="" href="<?php echo base_url() ?>PendafPindahC/riwayatpendafpindah">
          <i class="fa fa-book" ></i> 
          <span>Riwayat Pendaftaran Pindah</span> 
          </a>
        </li>
        <li class="<?php echo menuaktif('laporanpindah',$aktif); ?>"> 
          <a class="" href="<?php echo base_url() ?>PendafPindahC/laporanpendaftaranpindah">
          <i class="fa fa-table" ></i> 
          <span>Laporan Pendaftaran Pindah</span> 
          </a>
        </li>
    </section>
    <!-- /.sidebar -->
