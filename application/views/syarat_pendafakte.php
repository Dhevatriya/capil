  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Unggah Syarat Pendaftaran Akte
      </h1>
    </section>
    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Unggah Syarat Pendaftaran</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                          ...
                          <th><center>Status Unggah Syarat</center></th>
                    ...
                    <tbody>
                      ...
                      <tr>   
                        ...
                        <td colspan=""><center><a href="<?php echo site_url('PendafAkteC/detailsyaratakte/'.$value->id_pendaftaran); ?>" class="btn btn-success btn-xs tooltips" data-popup="tooltip" data-original-title="Detail Data" data-placement="top"><i class="icon-zoomin3"></i></a></center></td>
                      </tr>
                      <?php  endforeach; ?>
