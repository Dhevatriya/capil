  ...
  ?>
    <section class="wrapper">
      <div class="row">
        ...
        <br>
        <?php } ?>
          <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="<?=site_url('PendafAkteC/searchdata/');?>">
              ...
              <section class="panel">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                     ...
                     <a href="<?php echo site_url('PendafKKC/caridatakk/') ?>"><button class="btn btn-primary" type="submit " >Cari</button></a>
                </div>
                    <center>  
                    </center> 
                      </div>
