              ...
              <table id="example1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                          ...
                          <th><center>Jenis Akte</center></th>
                    ...
                    <tbody>
                      ...
                      <tr>   
                        ...
                        <td colspan=""> <?php echo $value->jenis_akte; ?></td>
                        <td colspan=""><?php echo $value->tgl_daftar; ?></td>
                        <td colspan=""> <?php echo $value->tgl_jadi; ?></td>
                        <td colspan=""><center><a href="<?php echo base_url('PendafAkteC/detailriwayatakte/'.$value->id_pendaftaran); ?>" class="btn btn-success btn-xs tooltips" data-popup="tooltip" data-original-title="Detail Data" data-placement="top"><i class="icon-zoomin3"></i></a></center></td>
                      </tr>
                      <?php  endforeach; ?>
