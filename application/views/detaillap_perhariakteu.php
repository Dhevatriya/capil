    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <h3 class="box-title"><a href="<?php echo base_url('PendafAkteC/cetaklapdetailaktehariu/'.$value['tgl_daftar']); ?>" ><button type="submit" class="btn btn-danger btn-sm"><span class="fa fa-print"></span></button></a>Detail Laporan Tanggal <?php echo $value['tgl_daftar'] ?></h3>
            <?php endforeach ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <tbody>
                      <?php $no=0; foreach ($perharianu as $value): $no++; ?>
