        ...
        <div class="col-xs-12">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#ppindah" data-toggle="tab">Pendaftaran Pindah</a></li>
            </ul>
            <div class="tab-content">
              <div id="ppindah" class="tab-pane active">
                <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="<?=base_url('PendafPindahC/inputdatapindah/');?>">
                       <div class="form">
...
<!--                           </div>  
                          ...
                          <div class="form-group ">
                              <label for="curl" class="control-label col-lg-2" >Jumlah Anggota Pindah<span class="required" style="color: red;">*</span></label>
                              <div class="col-lg-9 <?php if(form_error('jumlah_anggota_pindah')!='') echo $id2; ?>">
                                  <input class="form-control " id="jumlah_anggota_pindah" type="text" name="jumlah_anggota_pindah" placeholder="Masukkan Jumlah Anggota Pindah" value="<?php echo $jumlah_anggota_pindah; ?>" class="form-control m-bot15" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')"/>
                                   <?php echo form_error('jumlah_anggota_pindah');?>
                              </div>
                          </div> 
                          <div class="form-group ">
                              <label for="curl" class="control-label col-lg-2" >Alamat Asal<span class="required" style="color: red;">*</span></label>
                          ...
                          <div class="form-group ">
                              <label for="curl" class="control-label col-lg-2" >RT Asal<span class="required" style="color: red;">*</span></label>
                              ...
                              <label for="curl" class="control-label col-lg-1">RW Asal<span class="required" style="color: red;">*</span></label>
                        ...
                        <?php $dataE=$this->session->userdata('parEdit'); ?>
                          <div class="form-group ">
                                  <label for="cname" class="control-label col-lg-2" style="padding-left: 7%;">Kecamatan Asal <span class="required" style="color: red;">*</span></label>
                                  <div class="col-lg-9">
                              ...
                              <div class="form-group ">
                                  <label for="cemail" class="control-label col-lg-2" style=" padding-left: 7%;">Desa/Kelurahan Asal<span class="required" style="color: red;">*</span></label>
                                  <div class="col-lg-9">
                          ...
                          <div class="form-group ">
                              <label for="curl" class="control-label col-lg-2" >Tujuan<span class="required" style="color: red;">*</span></label>
                              <div class="col-lg-9 <?php if(form_error('data_tujuan')!='') echo $id2; ?>">
                                  <textarea class="form-control " id="data_tujuan" type="text" name="data_tujuan" placeholder="Masukkan Tujuan" value="<?php echo $data_tujuan; ?>" class="form-control m-bot15" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')"></textarea>
