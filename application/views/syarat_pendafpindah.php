              ...
              <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>   
                        ...
                        <td colspan=""><center><a href="<?php echo site_url('PendafPindahC/detailsyaratpindah/'.$value->id_pendaftaran); ?>" class="btn btn-success btn-xs tooltips" data-popup="tooltip" data-original-title="Detail Data" data-placement="top"><i class="icon-zoomin3"></i></a></center></td>
                      </tr>
                      <?php  endforeach; ?>
              ...
              <table id="example3" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>   
                        ...
                        <td colspan=""> <?php echo $value->data_tujuan; ?></td>
                        <td colspan=""> <?php echo $value->status_unggah; ?></td>
                        <td colspan=""><center><a href="<?php echo site_url('PendafPindahC/detailsyaratpindahd/'.$value->id_pendaftaran); ?>" class="btn btn-success btn-xs tooltips" data-popup="tooltip" data-original-title="Detail Data" data-placement="top"><i class="icon-zoomin3"></i></a></center></td>
                      </tr>
                      <?php  endforeach; ?>
