<section id="main-content">
  ...
  <div class="content-wrapper">
   ...
   <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="<?=base_url('PendafPindahC/updateSyaratpd/'.$this->uri->segment(3));?>">
        <div>
              <section class="panel">
                ...
                <a href="<?php echo base_url('PendafPindahC/detailsyaratpindahd/').$datapendaftaran['id_pendaftaranFK'] ?>"><button class="btn btn-default" name="batal" type="button">Kembali</button></a>
                </center>
              </form>
              </div>
          </div>
