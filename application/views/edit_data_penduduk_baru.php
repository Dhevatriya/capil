  ...
  ?>
    <section class="wrapper">
      ...
      <?php } ?>
       ...
       <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="<?=site_url('PendafKKC/datapendudukeditbaruproses');?>">
<!--               <input id="noKK" name="noKK" type="hidden" value="<?php echo $get_datakeluarga['noKK']; ?>"/> -->
              <section class="panel">
              ...
              <div class="form-group ">
                  ...
                  <center><div class="form-group ">
                      <div class="col-lg-12">
                          ...
                          <a href="<?php echo site_url('PendafKKC/caridatanik/'.$get_datapenduduk['nik']) ?>"><button class="btn btn-default" name="batal" type="button">Batal</button></a>
                      </div>
                  </center></div>
              </form>
            </center>
