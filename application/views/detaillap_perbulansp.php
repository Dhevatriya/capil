    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <h3 class="box-title"><a href="<?php echo base_url('PendafPindahC/cetaklapdetailspbulan/'.$value['MONTH(tgl_daftar)']); ?>" ><button type="submit" class="btn btn-danger btn-sm"><span class="fa fa-print"></span></button></a>Detail Laporan Bulan <?php echo getnamabulan($value['MONTH(tgl_daftar)']), ($value['YEAR(tgl_daftar)']) ?></h3>
            <?php endforeach ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                          ...
                          <th><center>Jumlah Anggota Pindah</center></th>
                    ...
                    <tbody>
                      <?php $no=0; foreach ($perbulanan as $value): $no++; ?>
                      ...
                      <td><center><?php echo $no; ?></center></td>
                        ...
                        <td ><center><?php echo $value->tempat_lahir; ?>, <?php echo $value->tanggal_lahir; ?></center></td>
                        <td ><center><?php echo $value->jenis_kelamin; ?></center></td>
                        <td ><center><?php echo $value->jumlah_anggota_pindah; ?></center></td>
                        ...
                        <td ><center><?php echo $value->data_tujuan; ?></center></td>
