      ...
      <table border="1" align="center" cellspacing="" cellpadding="10" >
        <tbody>
          <tr style="background-color:#D8D8D8;">
            ...
            <th style="position:absolute; width:220; padding:5; border: 1px solid; text-align:center;" > Bulan </th>
          ...
          <tr style="background-color:#F4F4F4;">
            ...
            <td style="border: 1px solid; text-align:center; padding:5;"><?php echo getnamabulan($val->kategori_bulan); ?>  <?php echo $val->kategori_tahun;?></td>
