              ...
              <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>   
                        ...
                        <td colspan=""><center><a href="<?php echo site_url('PendafKKC/detailriwayatkk/'.$value->id_pendaftaran); ?>" class="btn btn-success btn-xs tooltips" data-popup="tooltip" data-original-title="Detail Data" data-placement="top"><i class="icon-zoomin3"></i></a></center></td>
                      </tr>
                      <?php  endforeach; ?>
