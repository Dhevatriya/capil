    ...
    <section class="content">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <h3 class="box-title"><a href="<?php echo base_url('PendafKKC/cetaklapdetailkktahun/'.$value['YEAR(tgl_daftar)']); ?>" ><button type="submit" class="btn btn-danger btn-sm"><span class="fa fa-print"></span></button></a>Detail Laporan Tahun <?php echo $value['YEAR(tgl_daftar)']?></h3>
            <?php endforeach ?>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
