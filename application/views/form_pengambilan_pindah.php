...
<!--                   <a data-popup="tooltip" data-placement="top" href="<?php echo site_url('PendafPindahC/unggahsyaratp/'.$data->id_pendaftaran); ?>" ><button class="btn btn-primary" name="unggah" type="button">Unggah Syarat</button></a> -->
