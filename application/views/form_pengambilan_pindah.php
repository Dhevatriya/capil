    ...
    <div class="row">
      <div class="col-lg-6">
       ...
       <?php foreach($datapendaf as $data){ ?>
             <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="<?=base('PendafPindahC/cetakpendafpindah/'.$data->id_pendaftaran)?>">
              ...
              <section class="panel">
               <center>
                <div class="panel-body" style="text-align:center;">
                      ...
                      <tr>
                        <th style="width:23%;">Alamat Asal </th>
                        <td> : </td>
        ...
        <div class="box-header with-border">
              <h3 class="box-title">Edit Data Pendaftar</h3>
                ...
                <div class="panel-body" style="text-align:center;">
                  ...
                  <div class="form-group ">
                      <label for="cname" class="control-label col-lg-3" style="text-align: left; padding-left: 7%;">Alamat Asal<span class="required">*</span></label>
                      <div class="col-lg-8">
                  ...
                  <div class="form-group ">
                      <label for="cname" class="control-label col-lg-3" style="text-align: left; padding-left: 7%;">RT Asal<span class="required">*</span></label>
                      <div class="col-lg-3">
                      ...
                      <label for="cname" class="control-label col-lg-2" style="text-align: left; padding-left: 3%;">RW Asal<span class="required">*</span></label>
                      <div class="col-lg-3">
                    ...
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-3" style="text-align: left; padding-left: 7%;">Kecamatan Asal<span class="required">*</span></label>
                        <div class="col-lg-8">
                    ...
                    <div class="form-group ">
                      <label for="cname" class="control-label col-lg-3" style="text-align: left; padding-left: 7%;">Desa/Kelurahan Asal<span class="required">*</span></label>
                        <div class="col-lg-8">
                  ...
                  <div class="form-group ">
                      <label for="cname" class="control-label col-lg-3" style="text-align: left; padding-left: 7%;">Tujuan<span class="required">*</span></label>
                      <div class="col-lg-8">
