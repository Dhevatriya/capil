  ...
  <br>
    <table border="0" align="left" cellspacing="0" cellpadding="10">
      <tbody>
        ...
        <tr>
          <th style="position:absolute; width:auto; text-align:left; padding:5; padding-top: 10; padding-left: 50;"> Nomor KK </th>
          <td style="padding:5; padding-top: 10; padding-left: 40;"> : </td>
          <td style="text-align:left; width:auto; padding:5; padding-top: 10; padding-left: 10;"><?php echo $d['noKK']; ?></td>
        </tr>
        <tr>
        ...
        <tr>
          <th style="position:absolute; width:auto; text-align:left; padding:5; padding-top: 10; padding-left: 50;"> Nama Kepala Keluarga </th>
          <td style="padding:5; padding-top: 10; padding-left: 40;"> : </td>
          <td style="text-align:left; width:auto; padding:5; padding-top: 10; padding-left: 10;"><?php echo $d['nama_kepala_keluarga']; ?></td>
        </tr>
        <tr>
