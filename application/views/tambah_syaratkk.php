        ...
        <!-- <section class="content"> -->
          <div class="box box-primary">
            <div class="box-header with-border ">
              <h3 class="box-title">Syarat Pendaftaran KK</h3>
            </div>

   <form class="form-validate form-horizontal" id="feedback_form" method="POST"  action="<?=base_url('PendafKKC/updateSyarat/'.$this->uri->segment(3));?>">
        <div>
              <section class="panel">
                ...
                <?php $dataE=$this->session->userdata('petEdit'); ?>
                  ...
                  <a href="<?php echo base_url('PendafKKC/detailsyaratkk/').$datapendaftaran['id_pendaftaranFK'] ?>"><button class="btn btn-default" name="batal" type="button">Kembali</button></a>
                  </center>
              </form>
              </div>
          </div>
