      ...
      <table border="1" align="center" cellspacing="" cellpadding="10" >
        <tbody>
          <tr style="background-color:#D8D8D8;">
            ...
            <th style="position:absolute; width:100; padding:5; border: 1px solid; text-align:center;"> Nomor KK </th>
            ...
            <th style="position:absolute; width:100; padding:5; border: 1px solid; text-align:center;"> Alamat </th>
          ...
          <tr style="background-color:#F4F4F4;">
            ...
            <td style="border: 1px solid; text-align:center; padding:5;"><?php echo $val->no_registrasi; ?></td>
                        <td style="border: 1px solid; text-align:center; padding:5;"><?php echo $val->nokk; ?></td>
            <td style="border: 1px solid; text-align:center; padding:5;"><?php echo $val->nik; ?></td>
            <td style="border: 1px solid; text-align:center; padding:5;"><?php echo $val->nama_kepala_keluarga; ?></td>
