            ...
            <div class="top-nav notification-row">  
                <ul class="nav pull-right top-menu">
                     <li class="<?php echo menuaktif('akte',$aktif); ?>"> 
                        <a class="" href="<?php echo site_url('PendafAkteC') ?>" class=""> <span>Pendaftaran Akte</span> </a>
                    </li>
                    <li > 
                        <a class="" href="<?php echo site_url('PendafAkteC/laporanpendaftaranakte') ?>" class=""> <span>Laporan Pendaftaran Akte</span> </a>
                    </li>
