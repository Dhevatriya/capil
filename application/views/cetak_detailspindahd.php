      ...
      <table border="1" align="center" cellspacing="" cellpadding="10" >
        <tbody>
          <tr style="background-color:#D8D8D8;">
            ...
            <th style="position:absolute; width:100; padding:5; border: 1px solid; text-align:center;"> Asal </th>
            <th style="position:absolute; width:100; padding:5; border: 1px solid; text-align:center;"> Alamat Tujuan </th>
          ...
          <tr style="background-color:#F4F4F4;">
            ...
            <td style="border: 1px solid; text-align:center; padding:5;"><?php echo $val->data_asal; ?></td>
